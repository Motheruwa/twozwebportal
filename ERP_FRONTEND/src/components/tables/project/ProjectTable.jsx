...
const ProjectTable = ({ vacancyData, loading, reload }) => {
  ...
  const DeleteSlider = async (id) => {
    ...
    setBanLoading(true);
    try {
      const res = await axios.get(`${BACKENDURL}/project/delete?id=${id}`);
  ...
  return (
    <div>
      <ModalForm
        ...
        title={<Divider>Update Project</Divider>}
        content={<UpdateProjectForm initialData={modalContent} sliderId={modalContent.id} reload={reload} openModalFun={()=>setModalOpen(false)}/>}
      />
      <Table
        size="small"
        columns={columns}
